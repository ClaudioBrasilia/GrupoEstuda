...
Deno.serve(async (req) => {
  ...
  // Função de cron: exige segredo compartilhado para impedir invocação pública.
  // Configure CRON_SECRET nos secrets da Edge Function e envie o mesmo valor
  // no header x-cron-secret ao agendar o job.
